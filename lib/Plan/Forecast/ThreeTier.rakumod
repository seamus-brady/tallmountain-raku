...
class Plan::Forecast::ThreeTier is Plan::Forecast::Base {
    # Three level of features with Feature->FeatureSet->GroupedFeatureSet of a forecasted future.

    has $.LOGGER = Util::Logger.new(namespace => "<Plan::Forecast::ThreeTier>");
