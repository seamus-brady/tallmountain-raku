...
use Normative::Extraction::NormativeExtractionResult;
...
class Normative::UserTask does Normative::Role::Endeavour {
    ...
    method get-from-statement(Str $statement --> Normative::UserTask) {
        ...
        my $analysis_result = Normative::Extraction::NormativeExtractionResult.new-from-data($extracted_norms.Hash);
