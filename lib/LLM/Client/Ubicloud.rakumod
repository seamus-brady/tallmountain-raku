...
class LLM::Client::Ubicloud does LLM::Role::Client {
    has Str $.api-key = %*ENV{"UBICLOUD_API_KEY"};
    has Str $.api-url = "https://llama-3-3-70b-it.ai.ubicloud.com/v1/chat/completions";
    has Str $.model = Util::Config.get_config('ubicloud', 'ubicloud_chat_completion_model');

    has $.LOGGER = Util::Logger.new(namespace => "<LLM::Client::Ubicloud>");
